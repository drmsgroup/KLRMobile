...
namespace KLRMobile.Services
{
    public class LRMRMockDataStore : IDataStore<LRMRResultItem>
    {
        ...
        public LRMRMockDataStore() { 
            ...
            items = new List<LRMRResultItem> {
                new LRMRResultItem { Id = 10000, FirstParty = "Smith, Smith", SecondParty="John, Smith", BookNumber="20", BookName="MARRIAGE", InstrumentType="MARRIAGE LICENSE", PageNumber="10", DateFiled=DateTime.Parse("10/12/2019"), LastUpdated=DateTime.Parse("10/12/2019"), UpdatedBy="red", Description="test", IndexedBy="red" },
