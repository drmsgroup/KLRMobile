...
namespace KLRMobile.Converters
{
    /// <summary>
    ...
    public class ErrorValidationColorConverter : IValueConverter
    {
        ...
        public object Convert(object value, Type targetType, object parameter, CultureInfo culture)
        {
            ...
            if (PageVariantParameter == "0")
            {
                ...
                bindingContext.InvalidLoginIsVisible = !isFocused && !CheckValidEmail(bindingContext.EmailAddress);
                ...
                return bindingContext.InvalidLoginIsVisible ? Color.FromHex("#FF4A4A") : Color.Transparent;
            ...
            else
            {
                ...
                bindingContext.InvalidLoginIsVisible = !isFocused1 && !CheckValidEmail(bindingContext.EmailAddress);
                ...
                return bindingContext.InvalidLoginIsVisible ? Color.FromHex("#FF4A4A") : Color.FromHex("#ced2d9");
